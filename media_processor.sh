...
#   授權條款 (License Terms)                                                     #
#                                                                              #
# 本電腦程式著作（「整合式多功能應用平台」及其相關程式碼，以下簡稱「本著作」）依據                #
...
# 腳本設定
############################################
SCRIPT_VERSION="v2.6.6-beta.5" # <<< 版本號更新

############################################
# ★★★ 新增：使用者同意書版本號 ★★★
# 當您修改同意書內容時，請務必增加此版本號 (例如：1.0 -> 1.1)
############################################
AGREEMENT_VERSION="1.5" 
...
main_menu() {
    ...
    while true; do
        clear
        echo -e "${CYAN}=== 整合式多功能應用平台(IAVPP) ${SCRIPT_VERSION} ===${RESET}"
        display_countdown
...
handle_first_run_agreement() {
    ...
    _display_full_terms() {
        ...
        echo -e "
${CYAN}=======================================================================${RESET}
                     ${BOLD}整合式多功能應用平台 (IAVPP)${RESET}
         ${YELLOW}詳 細 使 用 同 意 事 項 書 (Full User Consent Agreement)${RESET}
${CYAN}=======================================================================${RESET}
${YELLOW}
本文件為「整合式多功能應用平台」之完整、詳細使用條款。
${RESET}
---
${WHITE}${BOLD}一、定義${RESET}
(1) ${BOLD}本軟體${RESET}：指由 adeend-co 開發發布之「整合式多功能應用平台」，包含
    其程式碼、文件及所有後續更新。
...
"
        ...
        case "$choice" in
            1)
                ...
                echo ""
                echo -e "您即將同意「整合式多功能應用平台 v${AGREEMENT_VERSION}」的使用條款。"
