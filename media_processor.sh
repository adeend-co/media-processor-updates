...
#   授權條款 (License Terms)                                                     #
#                                                                              #
# 本電腦程式著作（「整合式影音處理平台」及其相關程式碼，以下簡稱「本著作」）依據                #
...
######################################################################
# 新增：處理首次運行同意條款 (v3.1 - 對應 2025-06-26 版同意書)
...
(2) 本軟體僅限於個人、非商業性學術研究或教育目的使用。禁止利用
    本軟體從事任何侵害他人權利的行為。這些權利包括但不限於：
    著作權、肖像權、隱私權，或其他受法律保障之權利。
